...
export const routes: Routes = [
...

  {
    ...
    children: [
      ...
      { path: 'recettes-agence', loadComponent: () => import('./features/tableau-bord-agence/recettes-agence.component').then(m => m.RecettesAgenceComponent), canActivate: [directionGuard] },
